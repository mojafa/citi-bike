...
ON citibike_data.start_station_name = start_station_info.station_name
INNER JOIN neighbourhoods AS end_station_info
ON citibike_data.end_station_name = end_station_info.station_name
